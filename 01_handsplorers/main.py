...
from src.config import recheck, mouse, stay_on_top
...
def show_frames(className, classNames, frame, target, args):
    ...
    cv2.putText(frame, current_gesture, (10, 60), cv2.FONT_HERSHEY_SIMPLEX,
    ...
    cv2.putText(frame, mode, (10, 90), cv2.FONT_HERSHEY_SIMPLEX,
    ...
    while True:
        ...
        if not ret:
            ...
            if mouse == True:
                ...
                show_frames(className, classNames, frame,
                            detector.mouse_control, args)
            else:
                args = (className,)
                show_frames(className, classNames, frame, 
                            detector.check_gesture, args)
